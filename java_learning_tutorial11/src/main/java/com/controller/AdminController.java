	...
	AdminServiceImpli adminserviceIm;
	 ...
	 public Admin addAdmin(@RequestBody Admin admin) {
	  return adminserviceIm.addAdmin(admin);
		  ...
		  public String
		  findAdminByAdminId(@PathVariable int adminId) { 
			  return adminserviceIm.deleteAdmin(adminId);
		  
		  }
		  
		  @PutMapping("/adminUpdate") 
		  public Admin updateAdmin(@RequestBody Admin
		  admin) { return adminserviceIm.updateAdmin(admin);
		 
		  }
		  
			
			 @GetMapping("/findalladmin") 
			 public List<Admin> findAllAdmin() { return
			  adminserviceIm.getAllAdmin();
			  }
